...
/// <summary>
/// Provides System.Text.Json serialization and deserialization extensions for <see cref="CsvReportFormatter"/>.
/// </summary>
public static class CsvReportFormatterJsonExtensions
{
    ...
    /// <summary>
    /// Serializes the <see cref="CsvReportFormatter"/> instance to a JSON string.
    /// </summary>
    ...
    /// <summary>
    /// Deserializes a JSON string to a <see cref="CsvReportFormatter"/> instance.
    /// </summary>
    ...
    /// <summary>
    /// Attempts to deserialize a JSON string to a <see cref="CsvReportFormatter"/> instance.
    /// </summary>
    /// <param name="json">The JSON string to deserialize.</param>
